...
/**
 * Confirmação de ação destrutiva. Difere do Dialog em dois pontos que
 * importam quando o alvo é dado de outra pessoa: usa role="alertdialog" e não
 * fecha por clique-fora nem por Esc sem uma escolha explícita.
 */
