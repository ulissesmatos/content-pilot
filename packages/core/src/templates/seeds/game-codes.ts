...
export const gameCodesTemplate = {
  ...
  config: {
    ...
    images: { enabled: false, candidates: 5, inlineMax: 0, webSearch: true, sourceImages: true, cover: { width: 1280, height: 720 }, inline: { width: 1280, height: 720 }, format: 'webp', quality: 82 },
